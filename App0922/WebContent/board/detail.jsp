...
<%
	...
	BoardDTO dto=boarddao.select(Integer.parseInt(board_id));
%>
<style>
#box {
...
function del(){
	if(confirm("삭제하시겠습니까?")){
		//오라클을 연동해줄 jsp 를 요청하자!!
		location.href="/board/delete.jsp?board_id=<%=board_id%>";
	}	
}
function edit(){
	if(confirm("수정하시겠어요?")){
		...
		<table id="box" align="center" width="603" border="0" cellpadding="0"
			...
			<tr>
				<td height="30" align="right" style="padding-right: 2px;"><img
					...
					onClick="edit()"> <img src="/board/images/delete_btn.gif"
					width="61" height="20" onClick="del()"> <a href="list.jsp"><img
